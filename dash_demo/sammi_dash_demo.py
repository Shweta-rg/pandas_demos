...
df= pd.read_csv(r"C:\Users\ngupt\OneDrive\Desktop\perschoolas\pandas\pandas_demos\dash_demo\household_median_income_2017.csv")
#print(df.dtypes)
...
df_new['2016']= df_new['2016'].str.replace(',', '')
df_new['2016']= df_new['2016'].astype(int)
df_new['2015']= df_new['2015'].str.replace(',', '')
df_new['2015']= df_new['2015'].astype(int)
df_new['2014']= df_new['2014'].str.replace(',', '')
df_new['2014']= df_new['2014'].astype(int)
